#include "bitmap.h"
#include "generated/bitmap_datas/Roboto_Light_30.h"
#include <vector>
...
void Bitmap::update(UNUSED_PARAM float p_delta) {
	Roboto_Light_30_A data;
	DisplayServer::get_singleton()->print_bmp_to_display(data.data, get_position(), Vector2i(data.width, data.height));
}